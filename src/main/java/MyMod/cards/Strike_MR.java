...
public class Strike_MR extends CustomCard {

    //TODO:
    // 修改文本信息、创建json文件、寻找图片
    ...
    public Strike_MR() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.ATTACK, mountainsRiver.Enums.MR_CARD_COLOR , CardRarity.BASIC, CardTarget.ENEMY);
        //添加基础攻击标签和将伤害设为6
