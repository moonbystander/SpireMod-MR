...
public class Defend_MR extends AbstractMRCard {
...
//    public static final String IMG_PATH = "img/cards/Defend.png";
    ...
    public Defend_MR(){
        super(ID,NAME,AbstractMRCard.TESTIMG,COST,DESCRIPTION,CardType.SKILL, mountainsRiver.Enums.MR_CARD_COLOR,CardRarity.BASIC, CardTarget.SELF);
